...
import { 
  DollarSign, Clock, Users, Award, Globe, Shield,
...
const steps = [
  {
    ...
    description: 'Tell us about yourself, your expertise, and the languages you speak.',
  },
  {
    number: '02',
    title: 'Design Your Tours',
    description: 'Create unique experiences that showcase the best of your city.',
  },
  {
    number: '03',
    title: 'Get Verified',
...
const testimonials = [
  {
    ...
    quote: 'LocalGuide changed my life. I went from giving occasional tours to friends to earning a full-time income doing what I love.',
  ...
  },
  {
    ...
    quote: 'The platform makes everything easy—from managing bookings to getting paid. I can focus on creating amazing experiences.',
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-primary-foreground/80 mb-8">
              Share your city's hidden gems, meet travelers from around the world, and earn money doing what you love.
            </p>
            ...
            <div className="flex flex-wrap gap-8 mt-12">
              ...
              <div className="text-primary-foreground">
                ...
                <div className="text-primary-foreground/70 text-sm">Active guides</div>
              </div>
              <div className="text-primary-foreground">
                <div className="font-display font-bold text-4xl">120+</div>
                <div className="text-primary-foreground/70 text-sm">Cities worldwide</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Join a community of passionate locals making a difference in how people travel.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Real stories from guides who turned their passion into a thriving business.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {testimonials.map((testimonial) => (
              <div key={testimonial.name} className="bg-card rounded-2xl p-8 shadow-soft">
                ...
                <div className="flex items-center justify-between pt-6 border-t border-border">
                  ...
                  <div className="text-right">
                    <div className="font-display font-bold text-primary">{testimonial.earnings}</div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-secondary">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-primary-foreground/80 mb-8 max-w-xl mx-auto">
            Join thousands of guides already earning on LocalGuide. It takes less than 10 minutes to get started.
          </p>
          <Link to="/register?role=guide">
